...
const nice: ZoneCatalogEntry[] = [
  entry("nice", "mont-boron", 15, ["boulevard du mont boron"]),
  entry("nice", "cap-de-nice", 15, [
    "avenue cap de nice",
    "avenue jean lorrain",
    "boulevard maurice maeterlinck",
  ...
  entry("nice", "riquier", 8, [
    ...
    "boulevard pierre sola",
  ]),
  entry("nice", "saint-roch", 8, ["st roch"]),
  entry("nice", "nice-ouest", 8),
  entry("nice", "pasteur", 4),
  entry("nice", "ariane", 1, ["boulevard de l ariane", "place de l ariane"]),
  entry("nice", "chambrun", 10),
  entry("nice", "valrose", 8, ["avenue borriglione", "rue michelet", "rue frederic passy"]),
  entry("nice", "carras", 6, ["avenue de la californie", "avenue de fabron"]),
  entry("nice", "ferber", 6),
  entry("nice", "magnan", 4, ["avenue de pessicart", "chemin de terron", "route de bellet"]),
  ...
  entry("nice", "saint-sylvestre", 8, [
    ...
    "avenue saint sylvestre",
    "avenue gorbella",
    "boulevard auguste raynaud",
    "avenue cyrille besset",
    "rue vernier",
    "boulevard joseph garnier",
  ]),
  entry("nice", "corniche-fleurie", 9),
  entry("nice", "saint-isidore", 8, ["st isidore", "route de grenoble", "boulevard rene cassin"]),
  entry("nice", "caucade", 6, ["avenue de la lanterne", "avenue sainte marguerite"]),
  entry("nice", "madeleine", 4, ["boulevard de la madeleine", "chemin de la madeleine"]),
  entry("nice", "lingostiere", 4, [
    "boulevard comte de falicon",
    "rue saint jean d angely",
