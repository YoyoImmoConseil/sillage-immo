...
export const SILLAGE_AGENCY_KNOWLEDGE_VERSION = "book_v2_seller_pdf_addr2026";
...
export const SILLAGE_BRAND_SOCLE_VERSION = "brand_socle_v2";
...
- Adresse de l'agence : ${SILLAGE_ADDRESS_DISPLAY}.
