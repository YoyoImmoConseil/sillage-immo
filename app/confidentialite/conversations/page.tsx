  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      <header className="mb-8">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#141446]/60">
          Confidentialité
        </p>
        <h1 className="mt-3 text-3xl font-semibold text-[#141446]">
          Supprimer mes conversations IA
        </h1>
        <p className="mt-3 text-sm leading-relaxed text-[#141446]/80">
      ...
      <section className="mt-10 border-t border-[rgba(20,20,70,0.15)] pt-6 text-xs text-[#141446]/70">
        <p>
