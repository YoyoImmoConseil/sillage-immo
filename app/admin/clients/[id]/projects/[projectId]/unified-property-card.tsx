  ...
  return (
    <section className="rounded-3xl border border-[rgba(20,20,70,0.16)] bg-white/70 p-6">
      <div className="flex items-baseline justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-navy">Fiche bien unifiée</h2>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {f.source === "manual" && canEdit ? (
                    <button
                      ...
                      className="text-[11px] underline text-navy/70"
                    >
                      réinitialiser
                    </button>
                  ) : null}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {f.alternatives.map((alt, i) => (
                      <button
                        ...
                        className="flex items-center gap-1 rounded-md border border-[rgba(20,20,70,0.2)] bg-white px-2 py-1 text-xs text-navy hover:bg-sand disabled:opacity-60"
