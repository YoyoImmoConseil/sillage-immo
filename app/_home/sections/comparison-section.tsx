          ...
          <article className="flex flex-col gap-5 rounded-[28px] border border-navy/10 bg-sand/40 p-8">
            ...
            <ul className="space-y-3">
              {copy.alonePoints.map((point) => (
                <li key={point} className="flex items-start gap-3 text-sm text-navy/70">
                  <span className="mt-0.5 flex h-5 w-5 flex-none items-center justify-center rounded-full bg-navy/10 text-navy/70">
          ...
          <article className="flex flex-col gap-5 rounded-[28px] bg-navy p-8 text-sand shadow-xl">
            ...
            <ul className="space-y-3">
              {copy.sillagePoints.map((point) => (
                <li key={point} className="flex items-start gap-3 text-sm text-sand/90">
                  <span className="mt-0.5 flex h-5 w-5 flex-none items-center justify-center rounded-full bg-sand/20 text-sand">
